...
import src.MinMaxTypeMultiKnapsackInput;
import src.MinMaxTypeMultiKnapsackInputBin;
import src.MinMaxTypeMultiKnapsackInputItem;
import src.MinMaxTypeMultiKnapsackSolution;
...
public class SolutionChecker {
	...
	public static void main(String[] args) {
		...
		System.out.println(checker.check("./dataset/submit/MinMaxTypeMultiKnapsackInput-1000-input.json", "./dataset/submit/MinMaxTypeMultiKnapsackInput-1000-output.json"));

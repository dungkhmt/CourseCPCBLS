...
import khmtk60.miniprojects.G15.Solution2.src.MinMaxTypeMultiKnapsackInput;
import khmtk60.miniprojects.G15.Solution2.src.MinMaxTypeMultiKnapsackInputBin;
import khmtk60.miniprojects.G15.Solution2.src.MinMaxTypeMultiKnapsackInputItem;
import khmtk60.miniprojects.G15.Solution2.src.MinMaxTypeMultiKnapsackSolutionSol2;

public class SolutionCheckerSol2 {
	...
	public String check(String inputJson, String outputJson){
		try{
			...
			MinMaxTypeMultiKnapsackSolutionSol2 S = gson.fromJson(readerOutput, MinMaxTypeMultiKnapsackSolutionSol2.class);
			return check(I,S);
		}catch(Exception ex){
			ex.printStackTrace();
		}
	...
	public String check(MinMaxTypeMultiKnapsackInput I, MinMaxTypeMultiKnapsackSolutionSol2 S){
	...
	public static void main(String[] args) {
		...
		SolutionCheckerSol2 checker = new SolutionCheckerSol2();
        if(OSValidator.isWindows()) {
        	System.out.println(checker.check("src\\khmtk60\\miniprojects\\G15\\Solution2\\dataset\\submit\\MinMaxTypeMultiKnapsackInput-1000-input.json", "src\\khmtk60\\miniprojects\\G15\\Solution2\\dataset\\submit\\MinMaxTypeMultiKnapsackInput-1000-output.json"));
    		System.out.println(checker.check("src\\khmtk60\\miniprojects\\G15\\Solution2\\dataset\\submit\\MinMaxTypeMultiKnapsackInput-3000-input.json", "src\\khmtk60\\miniprojects\\G15\\Solution2\\dataset\\submit\\MinMaxTypeMultiKnapsackInput-3000-output.json"));
        } else {
        	System.out.println(checker.check("src/khmtk60/miniprojects/G15/Solution2/dataset/submit/MinMaxTypeMultiKnapsackInput-1000-input.json", "src/khmtk60/miniprojects/G15/Solution2/dataset/submit/MinMaxTypeMultiKnapsackInput-1000-output.json"));
    		System.out.println(checker.check("src/khmtk60/miniprojects/G15/Solution2/dataset/submit/MinMaxTypeMultiKnapsackInput-3000-input.json", "src/khmtk60/miniprojects/G15/Solution2/dataset/submit/MinMaxTypeMultiKnapsackInput-3000-output.json"));
        }

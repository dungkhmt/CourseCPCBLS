package khmtk60.miniprojects.G10.localsearch.constraints.multiknapsack;
...
public class MultiKnapsack extends AbstractInvariant implements IConstraint {
	...
	public static void main(String[] args) {
		...
		mns.print();
		 ...
		 //khmtk60.miniprojects.G10.localsearch.search.SA_search ts=new khmtk60.miniprojects.G10.localsearch.search.SA_search();

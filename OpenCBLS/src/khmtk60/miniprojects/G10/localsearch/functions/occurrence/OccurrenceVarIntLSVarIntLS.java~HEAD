package khmtk60.miniprojects.G10.localsearch.functions.occurrence;
...
public class OccurrenceVarIntLSVarIntLS extends AbstractInvariant implements
	...
	//x1.setValuePropagate(7);
		...
		khmtk60.miniprojects.G10.localsearch.applications.Test test=new khmtk60.miniprojects.G10.localsearch.applications.Test();
		test.test(o, 10000);

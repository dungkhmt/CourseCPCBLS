package khmtk60.miniprojects.G10.localsearch.functions.conditionalsum;
...
public class ConditionalSumFuncFuncFunc extends AbstractInvariant implements IFunction {
	...
	/*
	public ConditionalSumD(IFunctionD[] cf, IFunctionD[] w, int val) {
	...
	public ConditionalSumD(IFunctionD[] cf, int[] w, int val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = new IFunctionD[w.length];
	...
	public ConditionalSumD(IFunctionD[] cf, VarIntLS[] w, int val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
	...
	public ConditionalSumD(VarIntLS[] cf, IFunctionD[] w, int val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
	...
	public ConditionalSumD(VarIntLS[] cf, int[] w, int val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(VarIntLS[] cf, VarIntLS[] w, int val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(IFunctionD[] cf, IFunctionD[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = w;
	...
	public ConditionalSumD(IFunctionD[] cf, int[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = new IFunctionD[w.length];
		for (int i = 0; i < _f2.length; i++) {
	...
	public ConditionalSumD(IFunctionD[] cf, VarIntLS[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = new IFunctionD[w.length];
		for (int i = 0; i < _f2.length; i++) {
	...
	public ConditionalSumD(VarIntLS[] cf, IFunctionD[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(VarIntLS[] cf, int[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(VarIntLS[] cf, VarIntLS[] w, VarIntLS val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(IFunctionD[] cf, IFunctionD[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = w;
		_val = val;
	...
	public ConditionalSumD(IFunctionD[] cf, int[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = new IFunctionD[w.length];
		for (int i = 0; i < _f2.length; i++) {
	...
	public ConditionalSumD(IFunctionD[] cf, VarIntLS[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = cf;
		_f2 = new IFunctionD[w.length];
		for (int i = 0; i < _f2.length; i++) {
	...
	public ConditionalSumD(VarIntLS[] cf, IFunctionD[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(VarIntLS[] cf, int[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);
	...
	public ConditionalSumD(VarIntLS[] cf, VarIntLS[] w, IFunctionD val) {
		// semantic: represents \sum_{i\in cf.range: cf[i] == val} w[i]
		_f1 = new IFunctionD[cf.length];
		for (int i = 0; i < _f1.length; i++) {
			_f1[i] = new FuncVarConst(cf[i]);

...
import khmtk60.miniprojects.G1.algorithm1.Utils;
...
public class MultiknapsackStrat1 extends Multiknapsack{
...
//			System.out.println(i + " <--> " + choosenItem);
	...
	public void solve(int initStrategy) {
		...
		search(5, 1800, 500, 1000, itemBlacklist);
		System.out.println("Violation: " + _violations);
...
//		Utils.printSolution(this, blackList);
	...
	public static void main(String[] args) {
		...
		MultiknapsackStrat1 multiknapsack = new MultiknapsackStrat1();
		if(args.length > 0)
			multiknapsack.readData(args[0]);
		else
			multiknapsack.readData(inputJson);
		multiknapsack.solve(3);
		int[] sol = multiknapsack.getSolution();

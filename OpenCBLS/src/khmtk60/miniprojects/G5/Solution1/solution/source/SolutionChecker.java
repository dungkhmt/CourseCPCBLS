...
import solution.model.MinMaxTypeMultiKnapsackSolution;
...
public class SolutionChecker {
	...
	public static void main(String[] args) {
		...
		String viol = check.check("solution/MinMaxTypeMultiKnapsackInput-1000.json",
				"solution/output-mix-1000v2.json");

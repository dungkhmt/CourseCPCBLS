package khmtk60.miniprojects.G5.Solution1.localsearch.model;

import java.util.Set;
import java.util.TreeSet;

import khmtk60.miniprojects.G5.Solution1.core.VarInt;
...
public class VarIntLS extends VarInt {
	...
	public VarIntLS(LocalSearchManager mgr, int[] domain){
		super(1,0);
		_mgr = mgr;
		_domain = new TreeSet<Integer>();
		int min = 0;

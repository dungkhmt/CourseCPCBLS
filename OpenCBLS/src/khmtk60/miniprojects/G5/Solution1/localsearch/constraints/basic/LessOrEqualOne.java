...
public class LessOrEqualOne extends AbstractInvariant implements IConstraint {
	...
	public LessOrEqualOne(IFunction f1, IFunction f2) {
		this._f1 = f1;
		this._f2 = f2;
	...
	public LessOrEqualOne(IFunction f, VarIntLS x){
		_f1 = f;
	...
	public LessOrEqualOne(VarIntLS x, IFunction f){
	...
	public LessOrEqualOne(VarIntLS x1, VarIntLS x2){
		_f1 = new FuncVarConst(x1);
		_f2 = new FuncVarConst(x2);
		_ls = x1.getLocalSearchManager();
		post();
	}
	public LessOrEqualOne(IFunction f, int val)
	{
		_f1=f;
	...
	public LessOrEqualOne(int val, IFunction f)
	{
	...
	public LessOrEqualOne(VarIntLS x, int val){
		_ls = x.getLocalSearchManager();
		_f1 = new FuncVarConst(x);
		_f2 = new FuncVarConst(_ls,val);
		post();
	}
	public LessOrEqualOne(int val, VarIntLS x){
		_ls = x.getLocalSearchManager();
		_f2 = new FuncVarConst(x);

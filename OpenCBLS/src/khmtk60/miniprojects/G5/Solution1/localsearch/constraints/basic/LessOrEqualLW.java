package khmtk60.miniprojects.G5.Solution1.localsearch.constraints.basic;

import java.util.HashSet;

import khmtk60.miniprojects.G5.Solution1.localsearch.model.IFunctionD;
import localsearch.model.AbstractInvariant;
import localsearch.model.VarIntLS;
import khmtk60.miniprojects.G5.Solution1.localsearch.model.LocalSearchManager;
import khmtk60.miniprojects.G5.Solution1.localsearch.functions.basic.FuncVarConstD;
import khmtk60.miniprojects.G5.Solution1.localsearch.model.IConstraint;

public class LessOrEqualLW extends AbstractInvariant implements IConstraint {
...
//		post();
//	}
	public LessOrEqualLW(IFunctionD f, double val)
	{
		_f1=f;
	...
	public LessOrEqualLW(double val, IFunctionD f)
	{
...
//	}
	...
	public int getAssignDelta(VarIntLS x, int val) {
		...
		double v2 = (int)(_f2.getValue() + _f2.getAssignDelta(x, val));
		int nv;
		if (v1 > v2)
			nv = (int) (v1 - v2 - (0.1 * (_f1.getValue()-_f2.getValue())) );
		else nv = 0;
	...
	public void propagateInt(VarIntLS x, int val) {
		...
		if (_f1.getValue() > _f2.getValue())
			_violations = (int)(_f1.getValue() - _f2.getValue());
		else
			_violations = 0;
	}
	...
	public void initPropagate() {
		// TODO Auto-generated method stub
		if (_f1.getValue() > _f2.getValue())
			_violations = (int)(_f1.getValue() - _f2.getValue());//1;
		else
			_violations = 0;
	}

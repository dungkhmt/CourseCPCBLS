...
import khmtk60.miniprojects.G5.Solution2.model.MinMaxTypeMultiKnapsackInput;
import khmtk60.miniprojects.G5.Solution2.model.MinMaxTypeMultiKnapsackInputBin;
import khmtk60.miniprojects.G5.Solution2.model.MinMaxTypeMultiKnapsackInputItem;
import khmtk60.miniprojects.G5.Solution2.model.MinMaxTypeMultiKnapsackSolution;
...
public class SolutionChecker {
	...
	public String check(MinMaxTypeMultiKnapsackInput I, MinMaxTypeMultiKnapsackSolution S){
		...
		for(int b = 0; b < nbBins; b++){
			...
			if(loadP[b]>0 && loadP[b] > bins[b].getP()){
				violations++;
				violationP++;
			}
	...
	public static void main(String[] args) {
		...
		String viol = check.check("data/G5/data/MinMaxTypeMultiKnapsackInput-3000.json","data/G5/data/output-2395_3000.json");

	...
	public String check(MinMaxTypeMultiKnapsackInput I, MinMaxTypeMultiKnapsackSolution S){
		...
		for(int b = 0; b < nbBins; b++){
			...
			if(loadWeight[b] > 0 && loadWeight[b] < bins[b].getMinLoad()){
				violations++;
				violationW++;
//				System.out.println("violationsW in Bin: " + b);
			}
	...
	public static void main(String[] args) {
		...
		Check s = new Check();
		String inputFile = "./src/khmtk60/miniprojects/G8/inputoutputdata/MinMaxTypeMultiKnapsackInput.json";
		String outputFile = "./src/khmtk60/miniprojects/G8/outputGreedy.json";
		System.out.println(s.check(inputFile, outputFile));
	}

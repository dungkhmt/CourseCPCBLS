...
public class GraphPartitionCost extends AbstractInvariant implements IFunction {
	...
	public GraphPartitionCost(int[][] c, VarIntLS[] x){
	...
	public void propagateInt(VarIntLS z, int val) {
		...
		int d = map.get(z);// get corresponding node
		System.out.println("Vao");
	...
	public static void main(String[] args){
		...
		GraphPartitionCost f = new GraphPartitionCost(c, x);
	
		f.propagateInt(x[5], 0);
//		mgr.close();

/**
 * Một xe container cần vân chuyển 6 kiện hàng 0,1,2,3,4,5 đến các điêm giao lần lượt
 * theo thứ tự đó.Thùng ce có chiều dài L=6cm, rộng bằng W=4cm.Chiều dài và rộng của các kiện hàng
 * được cho bởi bảng
 * <p>
 * Hãy viết chương trình tìm  kiếm cục bộ dựa trên ràng buộc sắp xếp sao cho đẽn mỗi
 * điểm giao, việc tháo gỡ một kiện hàng không cần phải làm dịch chuyển kiện hàng chưa giao
 */

...
public class HillClimbingSearchS
{
	class AssignMove
	{
	    int i;
    ...
    public HillClimbingSearchS() {
        this.R = new Random();
    }
    
    public HillClimbingSearchS(int seed) {
        this.R = new Random(seed);
    }

    private void exploreNeighborhood(final IConstraint c, final VarIntLS[] x, final ArrayList<HillClimbingSearchS.AssignMove> candidate) {
    ...
    public void search(final IConstraint c, final int maxIter) {
        ...
        int it = 0;
        final ArrayList<HillClimbingSearchS.AssignMove> candidate = new ArrayList<HillClimbingSearchS.AssignMove>();
        while (it < maxIter && c.violations() > 0) {
            ...
            final HillClimbingSearchS.AssignMove m = candidate.get(this.R.nextInt(candidate.size()));

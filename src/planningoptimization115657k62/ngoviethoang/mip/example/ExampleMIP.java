package planningoptimization115657k62.ngoviethoang.mip.example;
...
public class ExampleMIP {
	...
	public static void solveMIP() {
		...
		MPConstraint c2 = solver.makeConstraint(-INF, 20);
		...
		if (rs != MPSolver.ResultStatus.OPTIMAL) {
			...
			System.out.println("Objective values = " + obj.value());
